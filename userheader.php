...
<h1 style="color:white;">Welcome <?php echo $_SESSION["username"] ?> to Delta Team!</h1>
...
<h1>
	<?php
		...
		?>
			<button type="button" style="height:50px; width:150px;" onClick="window.location = './welcome.php'"> Go to Dashboard </button>
		<?php
